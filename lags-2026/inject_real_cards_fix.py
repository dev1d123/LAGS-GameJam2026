...
def main():
    ...
    # Find the BoardGridCenter node end (using \s\S to match newlines)
    match = re.search(r'\[node name="BoardGridCenter"[\s\S]*?\ntheme_override_constants/v_separation = 15\n', content)
    if not match:
...
"""
    ...
    print("Done generating 16 real graphical cards.")
